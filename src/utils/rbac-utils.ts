...
export const PERMISSIONS: Record<string, string[]> = {
  // Dashboard Access - Keep ADMIN for basic system access
  VIEW_DASHBOARD: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER, ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT],

  // Student Management - Remove ADMIN, let MANAGER handle
  VIEW_ALL_STUDENTS: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER],
  CREATE_STUDENT: [ROLE_NAMES.MANAGER],
  EDIT_STUDENT: [ROLE_NAMES.MANAGER],
  DELETE_STUDENT: [ROLE_NAMES.MANAGER],
  VIEW_OWN_STUDENT_DATA: [ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT],

  // Financial Management - Remove ADMIN, let MANAGER handle
  VIEW_ALL_FINANCES: [ROLE_NAMES.MANAGER],
  MANAGE_FEES: [ROLE_NAMES.MANAGER],
  CREATE_PAYMENTS: [ROLE_NAMES.MANAGER],
  VIEW_OWN_PAYMENTS: [ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT, ROLE_NAMES.TEACHER],
  GENERATE_BULK_PAYMENTS: [ROLE_NAMES.MANAGER],

  // Group & Schedule Management - Remove ADMIN, let MANAGER handle
  MANAGE_GROUPS: [ROLE_NAMES.MANAGER],
  VIEW_GROUPS: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER],
  VIEW_OWN_GROUPS: [ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT],
  MARK_ATTENDANCE: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER],
  MANAGE_SCHEDULES: [ROLE_NAMES.MANAGER],
  VIEW_SCHEDULES: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER, ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT],

  // Teacher & Salary Management - Remove ADMIN, let MANAGER handle
  MANAGE_TEACHERS: [ROLE_NAMES.MANAGER],
  VIEW_ALL_SALARIES: [ROLE_NAMES.MANAGER],
  VIEW_OWN_SALARY: [ROLE_NAMES.TEACHER],
  CALCULATE_SALARIES: [ROLE_NAMES.MANAGER],

  // System Administration - Keep ADMIN-only permissions
  MANAGE_USERS: [ROLE_NAMES.ADMIN],
  MANAGE_ROLES: [ROLE_NAMES.ADMIN],
  VIEW_STATISTICS: [ROLE_NAMES.MANAGER], // Remove ADMIN, let MANAGER handle
  SYSTEM_CONFIGURATION: [ROLE_NAMES.ADMIN],

  // AI Assistant Access - Remove ADMIN, redistribute
  AI_FULL_ACCESS: [ROLE_NAMES.MANAGER], // Transfer to MANAGER
  ...
  // Timetable Management - Remove ADMIN, let MANAGER handle
  MANAGE_TIMETABLE: [ROLE_NAMES.MANAGER],
  VIEW_TIMETABLE: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER, ROLE_NAMES.STUDENT, ROLE_NAMES.PARENT],
  CREATE_TIMETABLE_EVENTS: [ROLE_NAMES.MANAGER, ROLE_NAMES.TEACHER],
};
