...
//Selectors
export const selectAcademicYears = (state: { academicYear: AcademicYearState }) => state.academicYear.academicYears;
export const selectAcademicYear = (state: { academicYear: AcademicYearState }) => state.academicYear.academicYear;
export const selectLoading = (state: { academicYear: AcademicYearState }) => state.academicYear.loading;
